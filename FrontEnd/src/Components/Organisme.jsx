        ...
        <div className="organisme pt-10 pb-10 px-2 sm:px-4 md:px-8 2xl:pt-32 2xl:pb-44">
            <div className="flex justify-center mb-8 sm:mb-10 2xl:mb-8 sm:-ml-96">
                <svg width="65" height="74" viewBox="0 0 65 74" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path d="M45.9331 50.7562C36.5989 52.3361 27.8821 55.1674 28.2214 56.556C28.7981 58.9512 32.3335 59.1086 40.4923 56.8983C45.0398 55.7784 49.8654 54.5212 51.3577 54.2171C52.8501 53.913 54.2052 53.3308 54.3813 52.8117C55.1209 50.6315 51.5892 49.7808 45.9331 50.7562Z" fill="#FFD000" />
                </svg>
            </div>
            ...
            <div className="w-full flex justify-center items-center">
                <div className="border-2 border-[#E3DBD8] rounded-[10px] shadow-lg bg-white w-full max-w-6xl flex flex-col md:flex-row p-2 sm:p-4 md:p-6 2xl:p-8 relative">
                    ...
                    <div className="absolute left-2 top-2 z-0 hidden md:block">
                        ...
                        <div className=" sm:ml-96 ml-110 -mt-16 sm:-mt-16 2xl:ml-140">

                            <svg width="40" height="49" viewBox="0 0 47 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M41.584 3.59077C39.9826 5.35291 36.1055 10.1358 32.9027 14.1636C29.6999 18.2752 26.8342 21.296 26.4971 20.8765C26.0757 20.5408 25.2328 17.1844 24.4743 13.4923C22.9572 6.0242 22.1143 4.76553 20.1758 6.35984C19.3329 7.03113 18.9115 8.79326 18.9115 11.4784C18.9115 15.3383 17.9001 17.3522 16.8044 15.5901C16.1301 14.4992 5.17321 8.03806 3.99324 8.03806C3.48753 8.03806 2.81326 8.62544 2.56041 9.38064C2.22327 10.3037 4.24609 12.9888 9.38742 18.1913C13.3488 22.303 16.5516 25.7433 16.2987 25.9111C16.1301 26.079 12.9274 27.2537 9.21885 28.5124C1.88613 31.1136 0.369019 31.9527 0.369019 33.7149C0.369019 35.1414 3.48753 35.2253 11.4102 33.9666C14.613 33.3792 17.4787 33.2114 17.7315 33.4631C18.0687 33.7149 15.9616 37.9104 13.0959 42.6934C8.12316 51.1684 6.77461 55.0283 9.05028 55.0283C10.4831 55.0283 13.5173 51.7558 18.4058 44.7072C20.5972 41.6025 22.7043 39.0852 22.9572 39.0852C23.2943 39.0852 24.4743 41.5186 25.4857 44.4555C27.3399 49.658 29.2785 51.8397 30.1213 49.7419C30.2899 49.1545 30.037 45.7981 29.447 42.1899C28.8571 38.5817 28.7728 35.477 29.1099 35.2253C29.5313 34.9736 32.0599 36.3161 34.6727 38.0783C48.0738 47.1407 50.7709 45.9659 40.404 35.7288C36.9483 32.2884 34.0827 29.2676 34.0827 28.9319C34.0827 28.5963 36.5269 27.6733 39.5611 26.9181C48.2424 24.5686 47.821 22.1351 38.9711 22.8064C36.2741 22.9743 34.0827 22.9743 34.0827 22.7225C34.0827 22.4708 36.7798 18.1074 39.9826 12.9049C45.461 4.17815 46.9781 0.486057 45.1239 0.486057C44.7025 0.486057 43.1011 1.91255 41.584 3.59077Z" fill="#38B000" />
                            </svg>
                        </div>
                        <div className="sm:ml-110 ml-120 -mt-20 sm:-mt-20 2xl:ml-150">
                            <svg width="28" height="32" viewBox="0 0 28 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M19.327 29.3357C18.998 28.1549 17.9767 25.1568 17.0997 22.6595C16.1863 20.1395 15.6552 18.0622 15.9298 18.0268C16.1909 17.9316 17.881 18.4652 19.6941 19.1266C23.3569 20.4718 24.1346 20.4398 23.9707 19.1557C23.9089 18.6033 23.2576 17.9425 22.0897 17.2184C20.4108 16.1776 19.8111 15.1889 20.8769 15.1812C21.5355 15.1783 27.339 12.0924 27.6613 11.5725C27.7995 11.3496 27.7282 10.8941 27.4688 10.5791C27.1594 10.1816 25.4389 10.3489 21.7716 11.2116C18.901 11.8484 16.5297 12.332 16.5258 12.1753C16.4989 12.0558 16.8628 10.3278 17.3284 8.35424C18.2001 4.42172 18.2495 3.52695 17.4831 3.0518C16.8626 2.66715 15.9742 4.01867 14.3574 7.84914C13.738 9.41882 13.0282 10.7268 12.8496 10.7703C12.648 10.851 11.3987 8.79122 10.1012 6.23878C7.77333 1.7623 6.46282 0.127262 5.84117 1.13002C5.44976 1.76138 6.0443 3.98082 7.77471 8.03551C8.5265 9.83831 9.04583 11.4456 8.97676 11.557C8.88466 11.7056 7.50389 11.5693 5.95019 11.2231C3.1808 10.6373 1.70231 10.9032 2.38451 11.8403C2.59394 12.0729 4.12292 12.8666 5.85349 13.5795C7.58406 14.2925 8.9575 15.0925 8.9749 15.309C8.96927 15.5625 7.69459 16.3147 6.21439 16.9909C-1.38819 20.4523 -1.61399 21.9575 5.67069 20.1499C8.11108 19.5548 10.2078 19.1067 10.3538 19.1972C10.4998 19.2877 10.2336 20.6136 9.73319 22.1542C8.38365 26.6131 9.5572 27.0836 11.6827 23.003C12.3465 21.7692 12.9451 20.8036 13.0546 20.8715C13.1641 20.9394 14.3252 23.3044 15.7132 26.1185C18.0124 30.8857 19.2038 32.5498 19.7104 31.7327C19.8255 31.547 19.6425 30.4567 19.327 29.3357Z" fill="#FFD000" />
                            </svg>
                        ...
                        <div className="flex flex-col sm:flex-row mt-2">
                            ...
                            <div className="my-2 flex justify-end">
                                <svg width="6" height="72" viewBox="0 0 6 72" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <defs>
                                        <linearGradient id="paint0_linear_195_571" x1="2.78456" y1="0.20166" x2="2.78456" y2="71.1066" gradientUnits="userSpaceOnUse">
