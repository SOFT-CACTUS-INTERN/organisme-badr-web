    ...
    return (
        <section className=" w-full  min-h-screen flex justify-center items-center " >
            ...
            <img
                src={chms}
                alt="chms"
                className="  absolute top-[9%] lg:top-[6%] md:top-[10%] md:right-[62%]  right-32 lg:right-[58%]"
            />
            <div className="bg-white rounded-2xl   shadow-md lg:w-3/4 md:w-full h-screen sm:w-3/4 w-full sm:h-100 flex flex-col md:flex-row justify-center md">
                <img
                    src={or}
                    alt="or"
                ...
                <img
                    src={focht}
                    alt="focht"
                    className=" absolute  lg:top-[11%]"
                />
                <img
                    src={focht2}
                    alt="focht2"
                    className=" absolute right-[45%] sm:block lg:block md:hidden hidden 2xl:block   lg:top-[11%]"
                />
                <div className="container relative w-full md:w-1/2 flex items-end justify-center mb-6 md:mb-0 z-10 min-h-[250px] sm:min-h-0 lg:w-1/2">
                ...
                <div className='w-full md:w-1/2 px-4 md:px-0 lg:w-1/2'>
                    ...
                    <div>
                        <h2 className='font-bold text-xl sm:text-2xl md:text-3xl lg:text-3xl text-center md:text-right' style={{ padding: '1.5rem' }}>
