...
const Header = () => {
  ...
  function selectLang(name, flagUrl) {
    document.getElementById("selected-lang").textContent = name;
      ...
      <header className="head ">
        <div className="info">
          ...
          <div className="organisme">
            ...
            <div className="ellip-type">
              <div className="ellipse"></div>
              <div className="type">منظمة غير حكومية</div>
          ...
          <div className="icons">
            ...
            <a href="https://www.facebook.com" target="_blank" rel="noopener noreferrer" className="facebook">
              <svg width="10" height="19" viewBox="0 0 10 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M2.78849 14.3416C2.69668 13.148 2.69668 11.9544 2.60486 10.669C2.60486 10.0263 2.32942 9.56718 1.5949 9.56718C1.13582 9.56718 0.676746 9.65899 0.58493 9.01628C0.493115 8.18995 0.309485 7.27181 0.58493 6.44547C0.58493 6.35366 0.952193 6.17004 1.13582 6.17004C2.51305 6.44548 2.78849 5.71095 2.78849 4.60917C2.78849 1.67109 5.2675 0.110218 8.48103 0.293848C9.39919 0.385663 9.39919 1.12019 9.39919 1.7629C9.30737 2.4056 9.67463 3.32376 8.48103 3.32376C7.47107 3.23195 6.73654 3.59921 6.73654 4.79281C6.73654 5.61915 6.82836 6.26184 7.83833 6.35365C9.30737 6.44547 9.03192 7.45545 9.03192 8.46542C9.12374 9.5672 8.57285 9.93443 7.56288 9.93443C6.55292 9.93443 6.36929 10.4853 6.36929 11.4035C6.36929 13.4234 6.36928 15.3515 6.27747 17.3715C6.18565 18.6569 5.91021 18.7487 4.16572 18.6569C2.97213 18.6569 2.78849 18.106 2.88031 17.096C2.69668 16.2697 2.69668 15.3515 2.78849 14.3416Z" fill="#007200" />
              </svg>
            </a>
          </div>
        ...
        <div className="second">
          ...
          <div className="language-selector" onClick={toggleLangList}>
            <span className="arrow"><svg width="11" height="7" viewBox="0 0 11 7" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M1.66602 1.71074L5.60518 5.6499L9.54434 1.71074" stroke="#004B23" stroke-width="1.81808" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            </span>
            <span className="lang-name" id="selected-lang">العربية</span>
            <img id="selected-flag" src="/flags/Morocco.png" alt="MA" />
            <ul className="lang-options hidden" id="lang-options">
              <li onClick={() => selectLang('العربية', '/flags/Morocco.png')}>
                العربية  <img src="/flags/Morocco.png" alt="MA" />
              </li>
              <li onClick={() => selectLang('English', '/flags/English.png')}>
                English <img src="/flags/English.png" alt="GB" />
              </li>
              <li onClick={() => selectLang('Français', '/flags/france.png')}>
                Français <img src="/flags/france.png" alt="FR" />
              </li>
            </ul>
          </div>
          ...
          <div className="logo">
            ...
            <img src="/flags/logo1.png" alt="Drapeau France" />
          ...
          <nav className="nav2">
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7.98755 9.93926L11.9267 13.8784L15.8659 9.93926" stroke="#004B23" stroke-width="1.81808" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              رعايتنا تضم
            </NavLink>
            <NavLink
          ...
          <div className="donate">
            <svg width="21" height="19" viewBox="0 0 21 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M11.2297 17.6435C10.9206 17.7526 10.4115 17.7526 10.1025 17.6435C7.46625 16.7435 1.57568 12.9892 1.57568 6.62595C1.57568 3.81703 3.83919 1.54443 6.62993 1.54443C8.28438 1.54443 9.74793 2.34439 10.6661 3.58068C11.5842 2.34439 13.0568 1.54443 14.7022 1.54443C17.4929 1.54443 19.7564 3.81703 19.7564 6.62595C19.7564 12.9892 13.8659 16.7435 11.2297 17.6435Z" stroke="white" stroke-width="1.81808" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <div className="now-donate">تبرع الآن</div>
