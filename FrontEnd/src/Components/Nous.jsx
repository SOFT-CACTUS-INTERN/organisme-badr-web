...
function Nous() {
    return (
        <section className="nous-section mt-12  2xl:ml-[10%] bg-[#FCFAF8]" style={{ padding: '0  8rem ' }}>
            <div className="nous-container flex flex-col lg:flex-row gap-8" style={{ padding: '0.5rem 1rem' }}>
                ...
                <img src={images} alt=""   className="relative hidden sm:block md:block 2xl:block lg:block  w-2/3 sm:w-full" />
                    {/* <img
